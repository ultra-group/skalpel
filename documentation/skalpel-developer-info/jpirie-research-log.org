...
Does the symbol $\hookrightarrow$ mean the same as
http://planetmath.org/InclusionMapping.html? If it does, why aren't we
using simply the standard subset symbol?
