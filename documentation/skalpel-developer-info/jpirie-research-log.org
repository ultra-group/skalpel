...
The skalpel help displayed at the command line does not accurately
reflect the parameters that skalpel takes (debugging parameters need
to be updated).
...
- Research open day poster, look at the new version
- Equality type endpoint locations
- Correctness of equality type tests in the test framework
