...
signature ENV = sig
    ...
    datatype env        = ENVCON of {vids : varenv,
			...
			| FUNCTOR_ENV of cst (*(2010-06-22)This environment is only solved when dealing with CSTFUN.*)
	 ...
	 and ocst       = TYPE_CONSTRAINT of (Ty.ty    * Ty.ty)    ExtLab.extLab
    ...
    val initTypeConstraint   : Ty.ty    -> Ty.ty    -> Label.label -> ocst
    val initFunctionTypeConstraint   : Ty.tyfun -> Ty.tyfun -> Label.label -> ocst
    val initTypenameConstraint   : Ty.tnty  -> Ty.tnty  -> Label.label -> ocst
    val initSequenceConstraint   : Ty.seqty -> Ty.seqty -> Label.label -> ocst
    val initRowConstraint   : Ty.rowty -> Ty.rowty -> Label.label -> ocst
    val initLabelConstraint   : Ty.labty -> Ty.labty -> Label.label -> ocst
    val initEnvConstraint  : env      -> env      -> Label.label -> ocst
    val initClassConstraint   : class    -> class    -> Label.label -> ocst
