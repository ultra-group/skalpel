...
signature TY = sig
    ...
    val stripEqualityVariables : ty -> Label.labels list -> equalityTypeVar list * Label.labels list
    val stripEqualityVariables_sequenceType : rowType -> Label.labels list -> equalityTypeVar list * Label.labels list
